...
public class Starfield : MonoBehaviour {
    ...
    void Update()
    {
        ...
        // older versions of <a href="#">Unity</a>
        // particleSystem.SetParticles ( points, points.Length );
        // <a href="#">Unity</a> 5.4+ and probably some sooner versions
        points.SetValue(points, points.Length);

        //SetParticles(points, points.Length);
